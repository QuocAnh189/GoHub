...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/api/v1/payments/get-transactions": {
            "get": {
                "description": "Fetches the details of a specific category based on the provided category ID.",
                "produces": [
                    "application/json"
        ...
        "/api/v1/statistics/customer-conversion-rate": {
            "get": {
                "description": "Fetches a paginated list of reviews based on the provided filter parameters.",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved the customer conversion rate",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/statistics/customer-retention-rate": {
            "get": {
                "description": "Fetches a paginated list of reviews based on the provided filter parameters.",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved the customer retention rate",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/statistics/customer-segmentation-rate": {
            "get": {
                "description": "Fetches a paginated list of reviews based on the provided filter parameters.",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved the customer segmentation rate",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/statistics/event-period-revenue": {
            "get": {
                "description": "Fetches a paginated list of reviews based on the provided filter parameters.",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved the Event Period Revenue",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/statistics/event-reviews-by-customer": {
            "get": {
                "description": "Fetches a paginated list of reviews based on the provided filter parameters.",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved the event reviews by customer",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/statistics/event-total-statistic": {
            "get": {
                "description": "Fetches a paginated list of reviews based on the provided filter parameters.",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved the event total statistic",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/statistics/overview-sale-statistic": {
            "get": {
                "description": "Fetches a paginated list of reviews based on the provided filter parameters.",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved the overview sale statistic",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/statistics/overview-total-statistic": {
            "get": {
                "description": "Fetches a paginated list of reviews based on the provided filter parameters.",
                "produces": [
                    "application/json"
                ...
                "responses": {
                    "200": {
                        "description": "Successfully retrieved the overview total statistic",
                        "schema": {
                            "$ref": "#/definitions/response.Response"
                        }
                    },
        ...
        "/api/v1/tickets/get-created-tickets": {
            "get": {
                "description": "Fetches the details of a specific expense based on the provided expense ID.",
                "produces": [
                    "application/json"
        ...
        "/api/v1/users/check-invitation/{inviteeId}": {
            "get": {
                "description": "Allows the authenticated user to follow another user by specifying the followed user's ID.",
                "produces": [
                    "application/json"
        ...
        "/api/v1/users/notification-following": {
            "get": {
                "description": "Allows the authenticated user to follow another user by specifying the followed user's ID.",
                "produces": [
                    "application/json"
        ...
        "/api/v1/users/notification-order": {
            "get": {
                "description": "Allows the authenticated user to follow another user by specifying the followed user's ID.",
                "produces": [
                    "application/json"
